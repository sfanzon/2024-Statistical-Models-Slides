...
A <span style="color: magenta-color;">**measurable**</span> 
function $X \colon \Omega \to \mathbb{R}$

:::


**Technicality**: [**red**]{style="color:magenta-color;"}
$X$ is a <span style="color:mymagenta;">measurable</span>
function if
$$
\{ \omega \in \Omega \colon X(\omega) \in \mathcal{A} \} \in \mathcal{B} \,, \quad \forall A \in \mathcal{L}
$$
where 
