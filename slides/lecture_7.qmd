...
3. **Interpretation**: Reject $H_0$ if 
    $$
...
2. **Statistical Tables or R**: 
    * Check that $E_i \geq 5$ for all $i, j$
...
- Using the values for $o_{i+}$ and $m$ we finally obtain the null probabilities

\begin{align*}
\text{Moyes: } \quad & p_{1j} = \frac{ o_{1+} }{ 3m } = 51 \big/ 1788  \\ 
\text{Van Gaal: }\quad & p_{2j} = \frac{ o_{2+} }{ 3m } = 103 \big/  1788  \\
\text{Mourinho: } \quad& p_{3j} = \frac{ o_{3+} }{ 3m } =  144 \big/  1788  \\
\text{Solskjaer: } \quad& p_{4j} = \frac{ o_{4+} }{ 3m } =  168 \big/ 1788 \\
\text{Rangnick: }\quad & p_{5j} = \frac{ o_{5+} }{ 3m } =  29 \big/  1788  \\
\text{ten Hag: }\quad & p_{6j} = \frac{ o_{6+} }{ 3m } =  101 \big/  1788 
\end{align*}
