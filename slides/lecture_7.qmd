...
$$
when $m = RC \to \infty$, where convergence is in distribution and
...
- To each person we associate two categories:
    * House Occupancy: Renter or Owner
...
- One possible question is:
    * Does type of House Occupancy depend on Region?
...
- Looking at the data, it seems clear that:
    * Renters in London are almost comparable to Owner occupiers
    * Renters in NW and SW are almost a third of number of Owner occupiers
    * It appears House Occupancy and Region are dependent quantities
