...
# Concatenate data to produce one long vector of scores
wages <- c(mathematicians, accountants)

# Create binary dummy variable called Group 
# Group is coded 0 if the person is Mathematician
# and 1 if the person is Accountant
