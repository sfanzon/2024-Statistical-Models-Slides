...
\frame{\frametitle{4.1 Statistical tests for autocorrelation}
\begin{enumerate}
  \item Runs test\\
$\quad$ \textbf{-} Under the classical multiple linear regression model residuals are equally likely to be positive or negative
  \item Durbin-Watson test\\
$\quad$ \textbf{-} Test to see if residuals are AR(1)
  \item Breusch-Godfrey Lagrange Multiplier test\\
$\quad$ \textbf{-} More general test for autocorrelation but outside the scope of this course
\end{enumerate}
