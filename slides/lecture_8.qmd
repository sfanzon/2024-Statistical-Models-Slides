...
$$
L \colon \R^n \to \R \,, \qquad \quad L(y_1,\ldots,y_n | \theta) := f(Y_1 = y_1, \ldots, Y_n = y_n | \theta)
$$
...
$$
L(y_1, \ldots, y_n | \alpha,\beta, \sigma^2) = \frac{1}{(2\pi \sigma^2)^{n/2}} \, \exp   \left(   -\frac{\sum_{i=1}^n(y_i-\alpha_i-{\beta}x_i)^2}{2\sigma^2}      \right)
$$
...
\begin{align*}
L(y_1, \ldots,y_n | \alpha,\beta,\sigma^2) & = f(y_1,\ldots,y_n) \\
                                  & = \prod_{i=1}^n f_{Y_i}(y_i)  \\
                                  & = \prod_{i=1}^n 
                                  \frac{1}{\sqrt{2\pi \sigma^2}} \exp \left( -\frac{(y_i-\alpha-\beta{x_i})^2}{2\sigma^2} \right) \\
                                  & = \frac{1}{(2\pi \sigma^2)^{n/2}} \, \exp   \left(   -\frac{\sum_{i=1}^n(y_i-\alpha_i-{\beta}x_i)^2}{2\sigma^2}      \right)
\end{align*}
...
$$
\max_{\alpha,\beta,\sigma} \ L(y_1, \ldots, y_n | \alpha,\beta,\sigma^2)
$$
...
$$
\max_{\alpha,\beta,\sigma} \ \log L(y_1, \ldots, y_n | \alpha,\beta, \sigma^2)
$$
...
$$
L(y_1, \ldots, y_n | \alpha,\beta, \sigma^2) =  \frac{1}{(2\pi \sigma^2)^{n/2}} \, \exp   \left(   - \frac{\sum_{i=1}^n(y_i-\alpha - \beta x_i)^2}{2\sigma^2}      \right)
$$


- Hence the log--likelihood is
$$
\log L(y_1, \ldots, y_n | \alpha,\beta, \sigma^2) 
...
\begin{align*}
\max_{\alpha,\beta,\sigma} \ & \log L(y_1, \ldots, y_n | \alpha,\beta, \sigma^2) 
= \max_{\sigma} \ \log L(y_1, \ldots, y_n | \hat\alpha, \hat\beta, \sigma^2) \\
