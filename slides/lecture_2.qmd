...
2. Bivariate random vectors
3. Conditional distributions
4. Independence
5. Covariance and correlation
6. Multivariate random vectors
...
- Proof of (1) follows by definition (see also argument in Slide 89 in Lecture 1)
...
**Note**: Above formula contains abuse of notation

- The first expectation is with respect to the marginal of $X$
- The second expectation is with respect to the marginal of $Y$
- The third expectation is with respect to the conditional distribution $X|Y$
...
# Part 4: <br>Independence {background-color="#cc0164" visibility="uncounted"}
...
# Part 5: <br>Covariance and correlation {background-color="#cc0164" visibility="uncounted"}
...
# Part 6: <br>Multivariate random vectors {background-color="#cc0164" visibility="uncounted"}
...
# Part 7: <br>Unbiased estimators {background-color="#cc0164" visibility="uncounted"}
