...
**Note**: The marginals of $X$ and $Y$ are just the usual pmfs of $X$ and $Y$
...
Marginals of $X$ and $Y$ can be computed from the joint distribution $f_{X,Y}$ 
...
- Note that $f_{X,Y}(x,y)=0$ for most of the pairs $(x,y)$

- Indeed $f_{X,Y}(x,y)=0$ if
$$
